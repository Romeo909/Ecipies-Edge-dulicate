...
ActiveRecord::Schema[7.1].define(version: 2023_12_14_213831) do
  ...
  create_table "user_recipe_collections", force: :cascade do |t|
    t.bigint "collection_id", null: false
    t.bigint "user_recipe_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["collection_id"], name: "index_user_recipe_collections_on_collection_id"
    t.index ["user_recipe_id"], name: "index_user_recipe_collections_on_user_recipe_id"
  end
  ...
  add_foreign_key "user_recipe_collections", "user_recipes"
